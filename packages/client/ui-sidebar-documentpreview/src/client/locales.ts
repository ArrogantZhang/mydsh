...
export const zh = {
  ...
  reload: '重新读取文件',
  download: '下载文件',
  'download.reading': '正在准备原文件…',
  'download.started': '下载已开始，请查看浏览器下载列表',
  'download.failed': '下载失败，请检查连接后重试',
  'wrap.enable': '自动换行',
  'wrap.disable': '取消换行',
  'wrap.aria': '自动换行',
  openWith: '打开方式',
  ...
  'error.tooLarge': '读取内容超过 {limit} 上限，无法读取',
...
export const en = {
  ...
  'download.reading': 'Preparing the original file…',
  'download.started': 'Download started. Check your browser downloads.',
  'download.failed': 'Download failed. Check your connection and retry.',
  ...
  'error.tooLarge': 'The requested content exceeds the {limit} limit and cannot be read.',
