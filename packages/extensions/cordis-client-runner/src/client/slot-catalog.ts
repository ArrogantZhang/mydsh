...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Empty-conversation presentation only; the real Composer remains outside this seat.',
    doc: 'Empty-conversation presentation only; the real Composer remains outside this seat.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'factory \'conversation.content\' (client-ui-conversation), so it exists while that definition is registered',
    occupants: [
      'client-ui-family-theme FamilyHero',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-family-theme FamilySettings id \'family-home\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Single document-title owner; no occupant uses the stock Session-aware title.',
    doc: 'Single document-title owner; no occupant uses the stock Session-aware title.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-family-theme FamilyTitle',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-family-theme FamilyMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-family-theme FamilyName',
    ],
    replaceRisk: 'shadows-shipped-ui',
