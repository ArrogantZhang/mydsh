...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    summary: 'Readiness fact for compositions that must not expose a dependent HTTP fallback without invite authentication.',
    description: 'Readiness fact for compositions that must not expose a dependent HTTP fallback without invite authentication. The route is registered before publication; owning-fiber withdrawal disposes dependent fibers before the route registration is removed.',
    methods: [
      {
        signature: 'readonly routePrefix: \'/__invite\'',
        description: 'Prefix reserved for invite-authentication HTTP routes.',
        parameters: [],
      },
    ],
  },
